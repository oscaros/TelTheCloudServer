...
define('ROLE_ACOUNTANT',                        '4');
define('ROLE_AGRICULTURAL_OFFICER',           	'5');
define('ROLE_PURCHASES_AGENT',                  '6');
define('ROLE_DATA_ENTRANT',                     '7');
define('ROLE_FARM_INSPECTOR',                 	'8');
...
define('FROM_NAME',                             'icam Admin System');	// Your system name
