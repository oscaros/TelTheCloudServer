...
class User extends BaseController
{
    ...
    function userListing()
    {
        ...
        else
        {
            ...
            $this->global['pageTitle'] = 'ICAM : User Listing';
    ...
    function addNew()
    {
        ...
        else
        {
            ...
            $this->global['pageTitle'] = 'ICAM : Add New User';
    ...
    {
        if($this->isAbleToAddUsers() == TRUE || $userId == 1)
        {
            $this->loadThis();
        }
        else
    ...
    {
        $this->global['pageTitle'] = 'ICAM : Change Password';
