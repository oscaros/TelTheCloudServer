            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                    <h3 class="box-title">Buying Stations List</h3>
                    <div class="box-tools">
                        <form action="<?php echo base_url() ?>stationListing" method="POST" id="searchList">
                ...
                <div class="box-body table-responsive no-padding">
                  <table class="table table-hover">
                    ...
                    <?php
                    if(!empty($stationRecords))
                    {
                        foreach($stationRecords as $record)
                        {
                    ?>
                    <tr>
                      <td><?php echo $record->bs_id ?></td>
                      <td><?php echo $record->bs_name ?></td>
                      <td><?php echo $record->subcounty_name ?></td>
                      <td><?php echo $record->bs_parish ?></td>
                      <td><?php echo $record->bs_createdby ?></td>
