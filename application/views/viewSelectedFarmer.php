...
<section class="content-header">
      <h1>
        <i class="fa fa-users"></i> Farmer Profile
        <small>Edit, Delete, Contact</small>
      </h1>
    </section>
          ...
          <div class="panel panel-info">
           ...
           //echo '<pre>'; print_r($organicData); echo '</pre>'; 
            ...
            <div class="panel-body">
              <div class="row">
                <div class="col-md-3 col-lg-3 " align="center"> <img alt="Farmer Pic" src="<?php 
               ...
               <?php } else { ?>
                  ...
                  <table class="table table-user-information">
                    <tbody>
                      ...
                      <tr>
                        ...
                        <tr>
                        <td>Farmer Was Mapped By</td>
                        <td><?php echo $record->mapped_by ?></td>
                        </tr>
                        <tr>
                        <td>Farmer Was Added By</td>
                        <td><?php echo $record->added_by ?></td>
                        </tr>
                        <tr>
                        <td>Farmer Was Added On</td>
                ...
                <div class="panel-footer">
                    <a data-original-title="Send Farmer Message" data-toggle="tooltip" type="button" class="btn btn-sm btn-primary"><i class="glyphicon glyphicon-envelope"></i></a>
                    <span class="pull-right">
                        <a href="<?php echo base_url().'editOldfarmers/'.$record->farmer_id; ?>" data-original-title="Edit this user" data-toggle="tooltip" type="button" class="btn btn-sm btn-warning"><i class="glyphicon glyphicon-edit"></i></a>
